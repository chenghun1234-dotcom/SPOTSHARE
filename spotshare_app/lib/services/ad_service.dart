...
class AdService {
  ...
  Future<Map<String, dynamic>> createAdVirtualAccount({
    ...
    final uri = Uri.parse(
      'https://us-central1-$projectId.cloudfunctions.net/createAdVirtualAccount',
    );
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      throw StateError('Virtual account issuance failed: ${response.statusCode} ${response.body}');
    }
